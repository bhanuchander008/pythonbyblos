...
class AddressSchema(ma.ModelSchema):
    class Meta:
        model = Addresses
        fields = ("id","address","latitude","longitude","userId","deliveryzoneId","type","createdAt","updatedAt")
...
class AddressUserSchema(ma.ModelSchema):
    class Meta:
        model = Addresses
        fields = ("id","address","latitude","longitude","userId","deliveryzoneId","type","createdat","updated")
        sqla_session = db.session
